...
targets are recorded in `migration/targets.lock.env`; they do not authorize a
direct Kubernetes 1.12-to-current jump or automatic use of the archived
`helm-2to3` plug-in. See `MIGRATION.md` for the backup, supported-cluster,
conversion, verification, cleanup, and rollback gates.
