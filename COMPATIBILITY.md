...
Before a release, validate Helm 2 and Helm 4 install, upgrade, rollback, remove, list, backend selection, health, malformed or oversized chart paths, secret-redaction, kubectl version, exact Helm versions, and a real catalog event round trip.
